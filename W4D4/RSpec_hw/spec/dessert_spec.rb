...
describe Dessert do
  ...
  let(:brownie) {Dessert.new("brownie", 4, chef)}
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["chocolate", "flour", "egg", "sugar", "batter"]
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect {brownie.eat(9)}.to raise_error("not enough left!")
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(brownie.serve).to eq ("Chef Mark the Great Baker has made 4 Brownies!")
    end
  end
